...
[Apache HttpClient](https://hc.apache.org/httpcomponents-client-ga/), enabling HTTP client spans and
metrics.
...
[latest release](https://central.sonatype.com/artifact/io.opentelemetry.instrumentation/opentelemetry-apache-httpclient-4.3).
