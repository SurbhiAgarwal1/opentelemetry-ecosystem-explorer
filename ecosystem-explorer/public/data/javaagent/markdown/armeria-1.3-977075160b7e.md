...
Provides OpenTelemetry instrumentation for [Armeria](https://armeria.dev/), enabling HTTP client
spans and metrics, and HTTP server spans and metrics.
...
[latest release](https://central.sonatype.com/artifact/io.opentelemetry.instrumentation/opentelemetry-armeria-1.3).
