...
[Jetty HttpClient](https://jetty.org/docs/jetty/12/programming-guide/client/http.html), enabling
database client spans and metrics.
...
[latest release](https://central.sonatype.com/artifact/io.opentelemetry.instrumentation/opentelemetry-jetty-httpclient-12.0).
