...
Provides OpenTelemetry instrumentation for the
...
[latest release](https://central.sonatype.com/artifact/io.opentelemetry.instrumentation/opentelemetry-aws-sdk-1.11).
...
The instrumentation library provides a `RequestHandler2` that can be added to any AWS SDK v1 client
builder to provide spans and context propagation.
