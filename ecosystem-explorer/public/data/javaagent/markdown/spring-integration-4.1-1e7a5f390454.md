...
[Spring Integration](https://spring.io/projects/spring-integration), enabling producer and consumer
messaging spans for Spring Integration.
...
[latest release](https://central.sonatype.com/artifact/io.opentelemetry.instrumentation/opentelemetry-spring-integration-4.1).
...
The instrumentation library provides a `ChannelInterceptor` implementation that can be added to your
Spring Integration message channels to provide spans and context propagation.
