...
[latest release](https://central.sonatype.com/artifact/io.opentelemetry.instrumentation/opentelemetry-ktor-3.0).
...
logging plugin is installed before this. You must set the `OpenTelemetry` to use with the feature.
...
`OpenTelemetry` to use with the feature.
